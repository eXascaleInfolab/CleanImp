...
def brits(incomp_data, model="rits_i", seq_len=24, epochs=50, batch_size=64, sliding_windows=1, hidden_layers=108, impute_weight=0.3, num_workers=0, seed=42, tr_ratio=0.9, logs=True, verbose=True):
    """
