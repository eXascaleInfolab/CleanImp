...
def stmvl(incomp_data, window_size=7, gamma=0.85, alpha=2, logs=True, verbose=True):
    """
    ...
    """
    window_size, gamma, alpha = utils.patch_classifiers_stmvl(incomp_data, window_size, gamma, alpha)
