import time
from wrapper.AlgoPython.IIM.runnerIIM import impute_with_algorithm


def iim(incomp_data, learning_neighbors=10, algo_code="iim 2", logs=True, verbose=True):
    """
    ...
    Example
    -------
        >>> recov_data = iim(incomp_data, learning_neighbors=10, algo_code="iim 2")
        >>> print(recov_data)
    ...
    recov_data = impute_with_algorithm(algo_code, incomp_data.copy(), learning_neighbors, verbose=verbose)
