...
from wrapper.AlgoPython.GRIN.lib import fillers, datasets, config
from wrapper.AlgoPython.GRIN.lib.data.datamodule import SpatioTemporalDataModule
from wrapper.AlgoPython.GRIN.lib.data.imputation_dataset import ImputationDataset, GraphImputationDataset
from wrapper.AlgoPython.GRIN.lib.nn import models
from wrapper.AlgoPython.GRIN.lib.nn.utils.metric_base import MaskedMetric
from wrapper.AlgoPython.GRIN.lib.nn.utils.metrics import MaskedMAE, MaskedMAPE, MaskedMSE, MaskedMRE
from wrapper.AlgoPython.GRIN.lib.utils import parser_utils, numpy_metrics, ensure_list, prediction_dataframe
from wrapper.AlgoPython.GRIN.lib.utils.parser_utils import str_to_bool
...
def runGRIN(incomp_data, seq_len=1, sim_type="corr", epochs=50, batch_size=32, sliding_windows=1, lr=0.001, adj_threshold=0.1, patience=40, num_workers=0, seed=42, tr_ratio=0.7, verbose=True, deep_verbose=False):
    ...
    seq_len, batch_size = utils_imp.patch_classifiers_grin(incomp_data=ts_m, seq_len=seq_len, batch_size=batch_size, verbose=verbose)
    ...
    args.adj_threshold = adj_threshold
    ...
    if verbose:
        ...
        print(f"call: gain.impute(params={{'seq_len': {seq_len}, 'sim_type': '{sim_type}', 'epochs': {epochs}, 'batch_size': {batch_size}, 'sliding_windows': {sliding_windows}, 'adj_threshold': {adj_threshold}, 'patience': {patience}, 'num_workers': {num_workers}}})\n")
